...
internal sealed class AccentInsensitivePreviewTitleRegressionCase : IRecordingValidationCase
{
    public string Id => "accent-insensitive-preview-title";
    ...
    public async Task RunAsync(string project, RecordingValidationCaseDefinition definition)
    {
        ...
        var expected = catalog.Single(card => card.Id == "203158");
