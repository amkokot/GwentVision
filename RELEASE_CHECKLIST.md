...
9. Push the version tag matching `Directory.Build.props`. The Release workflow builds, scans, and attaches the Windows ZIP plus its SHA-256 file. The README download link then resolves automatically.
